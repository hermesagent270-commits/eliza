 ...
 * dispatch) is retired.
 *
 * This tick builds/refreshes the owner `ActivityProfile`, persists it for
 * prompt context, and learns rhythm/schedule facts. Maintenance is not a
 * user request or a due scheduled job: it must not plan actions or create
 * approvals on the owner's behalf.
 *
...
const TASK_DESCRIPTION =
  "Activity-profile maintenance (proactive dispatch is owned by the scheduled-task runner)";
